  ...
  <div v-if="upyunUrl" class="bound-wrapper">
    <ul>
      <li>
        <h3>学校</h3>
        <div class="right">
          <input v-model="schoolVal" type="text" placeholder="请填写" />
        </div>
      </li>
      <li>
        <h3>学历</h3>
        <div class="right">
          <input v-model="cultureVal" type="text" placeholder="请填写" />
        </div>
      </li>
      <li>
        <h3>专业</h3>
        <div class="right">
          <input v-model="specialtyVal" type="text" placeholder="请填写" />
        </div>
      </li>
      <li>
        <h3>开始时间</h3>
...
export default {
  ...
  methods: {
    ...
    onSaveFn () {
      ...
      const schoolVal = this.schoolVal
      const cultureVal = this.cultureVal
      const specialtyVal = this.specialtyVal
      ...
      this.isEducationInfo(data).then(() => {
        if (this.oJson) {
